...
const IndividualRegistration = () => {
    return (
        <div className='individual-registration-container d-flex flex-column col-md-8 col-lg-7 col-xl-6 col-xxl-5'>
            ...
            <div className="individual-registration-form d-flex flex-column align-items-center">
                ...
                <button className="idendification-number d-flex align-items-center">
                ...
                <button className="digital-signature d-flex align-items-center">
